...
if __name__ == "__main__":
    ...
    # json.dump(model_schema, open("/home/jcg/SBOM/sbom-generator/SbomGT/schema/ossbom_model/ossbom.schema.json", "w"), indent=4)
    bom = json.load(open("/home/jcg/SBOM/sbom-generator/SbomGT/result/linuxsbom.json", "r"))
    OSSBOM(**bom)
