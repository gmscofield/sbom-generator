...
if __name__ == "__main__":
    import json
    examples = [
        "/home/jcg/SBOM/sbom-generator/SbomGT/result/linuxsbom.json",
    ]
    for path in examples:
        bom = json.load(open(path, "r"))
        ossbom = Ossbom2Middleware(bom).ossbom2middleware()
        json.dump(ossbom.model_dump(exclude_none=True), open("/home/jcg/SBOM/sbom-generator/SbomGT/output/midware.json", "w"), indent=4)
